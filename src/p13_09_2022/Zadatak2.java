...
//			Zatvara pretrazivac
		...
		WebElement searshInput = driver.findElement(By.xpath("//input[@id='userName']"));
													//By.id("userName")
		searshInput.sendKeys("itbootcamp");
		WebElement searshInput1 = driver.findElement(By.xpath("//input[@placeholder='Password']"));
		searshInput1.sendKeys("ITBootcamp2021!");
